...
public class PaymentGatewayImplServiceLocator extends org.apache.axis.client.Service implements PaymentGatewayImplService {
    ...
    public IPaymentGateway getPaymentGatewayImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public IPaymentGateway getPaymentGatewayImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            PaymentGatewayImplServiceSoapBindingStub _stub = new PaymentGatewayImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (IPaymentGateway.class.isAssignableFrom(serviceEndpointInterface)) {
                PaymentGatewayImplServiceSoapBindingStub _stub = new PaymentGatewayImplServiceSoapBindingStub(new java.net.URL(PaymentGatewayImplPort_address), this);
                _stub.setPortName(getPaymentGatewayImplPortWSDDServiceName());
                return _stub;
            }
        }
